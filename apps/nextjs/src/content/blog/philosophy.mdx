---
title: What is out Philosophy about AI?
...
The core philosophy emphasizes the following:
...
The philosophy also recognizes the importance of designing AI systems that are not only transparent but also equitable and governable. This means creating AI solutions that are fair in their operations and can be controlled to align with the organization's values and ethics.
