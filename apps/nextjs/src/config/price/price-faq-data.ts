...
export const priceFaqDataMap: Record<string, FAQItem[]> = {
  en: [
...

    {
      id: "item-3",
      question:
        "How can AI solutions improve transparency between enterprise departments?",
      answer:
...

    {
      id: "item-4",
      question:
        "What are the main benefits of using AI to enhance collaboration between marketing and IT departments?",
      answer:
...

    {
      id: "item-5",
      question:
        "How does the AI technology analyze and understand complex data in marketing and IT systems?",
      answer:
...

    {
      id: "item-6",
      question:
        "Can the workflows be customized to suit the specific needs of different departments within an enterprise?",
      answer:
...

    {
      id: "item-7",
      question:
        "What reporting capabilities does the AI technology provide for monitoring cross-department collaboration?",
      answer:
